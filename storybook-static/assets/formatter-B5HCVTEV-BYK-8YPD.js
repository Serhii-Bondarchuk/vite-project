...
import { m as ea } from "./index-CL4AuUwb.js";
...
var ta = Object.defineProperty,
  ...
  se = (e, t, r) => (
    hu(e, t, "read from private field"), r ? r.call(e) : t.get(e)
  ),
  ra = (e, t, r) => {
    if (t.has(e))
  ...
  na = (e, t, r, n) => (
    hu(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r
  ),
  du = {};
pu(du, {
  languages: () => Vl,
  ...
  function u(i) {
    switch (Ir(i)) {
      ...
      case Ye: {
        ...
        return (
          a ? ((a = a.map(n)), (s = a[0])) : (s = n(s)),
          t({ ...i, contents: s, expandedStates: a })
        );
      }
      case xt:
      case Bt:
  ...
  switch (Ir(e)) {
    ...
    case xr: {
      ...
      for (let r of e) {
        ...
        typeof n == "string" && typeof Pt(!1, t, -1) == "string"
          ? (t[t.length - 1] += n)
          : t.push(n),
          t.push(...u);
      }
...
function ss(e, t) {
  ...
  switch (t.htmlWhitespaceSensitivity) {
    ...
    default:
      return (
        (e.type === "element" && (!e.namespace || n || Xe(e)) && Oa[e.name]) ||
        Ia
      );
  }
}
...
function Hr(e, t) {
  return (
    Me(e, t) && (Mt(e, t) || (e.attrMap.lang && e.attrMap.lang !== "html"))
  );
}
function cs(e) {
  let t = e.fullName;
...
` && ++s == r
        ...
        return {
          before: n.substring(u, this.offset),
...
var Ou = class {
    ...
    contextualMessage() {
      ...
      return e
        ? `${this.msg} ("${e.before}[${wt[this.level]} ->]${e.after}")`
        : this.msg;
    }
    toString() {
...
function Cs(e) {
  let t = (r) => {
    ...
    return (
      ...
      ((u = r.firstChild) == null ? void 0 : u.type) ===
    ...
    if (r.children)
      for (let n = 0; n < r.children.length; n++) {
        ...
        let i = u.prev,
          a = u.next;
        (i.value +=
          `<${u.rawName}>` + u.firstChild.value + `</${u.rawName}>` + a.value),
                  ...
                  : [
                      {
                        type: "text",
                        value: l,
                        sourceSpan: new b(i.moveBy(2), a.moveBy(-2)),
                      },
                    ],
            });
        }
      ...
      for (let u = 0; u < t.children.length; u++) {
        ...
        s
          ...
          : (t.removeChild(i),
            u--,
            (a || o) &&
              (l && (l.hasTrailingSpaces = !0),
              c && (c.hasLeadingSpaces = !0)));
      }
...
function ks(e, t) {
  e.walk((r) => {
    ...
    if (n) {
      ...
      for (let u of n)
        (u.isLeadingSpaceSensitive = za(u, t)),
          (u.isTrailingSpaceSensitive = Ga(u, t));
      for (let u = 0; u < n.length; u++) {
        let i = n[u];
        (i.isLeadingSpaceSensitive =
          (u === 0 || i.prev.isTrailingSpaceSensitive) &&
          i.isLeadingSpaceSensitive),
          (i.isTrailingSpaceSensitive =
            (u === n.length - 1 || i.next.isLeadingSpaceSensitive) &&
            i.isTrailingSpaceSensitive);
      }
    }
  });
...
function Qe(e) {
  return (
    !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && H(Rr(e))
  );
}
function jt(e) {
  return (
...
function Os(e, t, r) {
  ...
  let i =
      ((n = u.prev) == null ? void 0 : n.type) === "comment" &&
      Is(u.prev.value),
    a =
      typeof i == "boolean"
        ? () => i
        : Array.isArray(i)
          ? (D) => i.includes(D.rawName)
          : () => !1,
    s = e.map(
      ({ node: D }) => (a(D) ? G(t.originalText.slice(Rt(D), Ht(D))) : r()),
      "attrs",
    ),
    o =
      u.type === "element" &&
  ...
  return (
    ur.has(r) ||
      ur.set(
        r,
        r.children.some(
          (n) => Lu(n, t) && ["ts", "typescript"].includes(n.attrMap.lang),
        ),
      ),
    ur.get(r)
  );
...
function Hs(e, t) {
  ...
  return (
    e.lastChild && Qe(e.lastChild)
      ? (n += Wr(e, t).length)
      : nt(e) && (n -= rt(e.lastChild, t).length),
...
function zs(e) {
  ...
  function p() {
    ...
    if (!h)
      ...
      throw new Error(`Invalid srcset descriptor found in "${e}" at "${C}".`);
  }
}
var Gs = zs;
function Wt(e, t = !0) {
...
function Re(e, t) {
  ...
  return (
    ...
    (r.type === "ObjectExpression" ||
      ...
      ((t.parser === "__vue_expression" ||
        t.parser === "__vue_ts_expression") &&
...
function Ys(e) {
  let t = Gs(e),
    r = Js.filter((c) =>
      t.some((D) => Object.prototype.hasOwnProperty.call(D, c)),
    );
  if (r.length > 1)
...
function eo(e, t) {
  ...
  if (r.fullName === "style" && !t.parentParser && !n.includes("{{"))
    return async (u) =>
      Wt(await u(n, { parser: "css", __isHTMLStyleAttribute: !0 }));
}
...
function Gr({ parser: e }) {
  return (t, r, n) =>
    X(de(n.node), t, { parser: e, trailingComma: "none" }, Re);
}
...
function fo(e, t) {
  ...
  let u = de(r);
  if (/^i18n(?:-.+)?$/.test(n))
    return () => Wt(gu(Tu(r, u.trim())), !u.includes("@@"));
...
function vo(e, t, r, n) {
  let { node: u } = r,
    i = n.originalText.slice(
      u.sourceSpan.start.offset,
      u.sourceSpan.end.offset,
    );
  return /^\s*$/.test(i)
    ? ""
    : X(
      ...
      if (!r.isSelfClosing && Hr(r, t)) {
        ...
        return n
          ? async (u, i) => {
              ...
              return (
                s ||
                  ((o = await u(Fu(a), { parser: n, __embeddedInHtml: !0 })),
                  (s = o === "")),
                [
                  ye(r, t),
                  q(gr(e, t, i)),
      ...
      if (ee(r.parent)) {
        ...
        if (n)
          return async (u) => {
            ...
            return [
              Ze,
              ye(r, t),
              await u(i, a, { stripTrailingHardline: !0 }),
              Fe(r, t),
            ];
          };
        ...
        return async (n) => {
          ...
          return (
            ...
            [
              we([L, await n(r.value, u)]),
              r.parent.next && ve(r.parent.next) ? " " : L,
            ]
          );
        };
      break;
...
function je(e, t, r) {
  ...
  return Mr(n)
    ? [
        ...
        G(
          t.originalText.slice(
            Rt(n) + (n.prev && jt(n.prev) ? Vr(n).length : 0),
            Ht(n) - (n.next && ve(n.next) ? rt(n, t).length : 0),
          ),
        ),
        Fe(n, t),
      ]
...
function So(e, t, r) {
  let { node: n } = e;
  if (vu(n, t))
    return [ye(n, t), q(gr(e, t, r)), G($u(n, t)), ...mr(n, t), Fe(n, t)];
  let u =
      n.children.length === 1 &&
...
function _o(e) {
  let { previous: t } = e;
  return (
    (t == null ? void 0 : t.type) === "angularControlFlowBlock" &&
    !zu(e.previous)
  );
}
function Bo(e, t, r) {
...
function Lo(e, t = "type") {
  ...
  function r(n) {
    let u = n[t],
      i = e[u];
    if (!Array.isArray(i))
      throw Object.assign(new Error(`Missing visitor keys for '${u}'.`), {
        node: n,
      });
    return i;
  }
    ...
    case "docType":
      return [
        q([
          mt(n, t),
          " ",
          O(!1, n.value.replace(/^html\b/i, "html"), /\s+/g, " "),
        ]),
        ft(n, t),
      ];
    case "comment":
...
var jo = class {},
  ...
  Ko = class extends jo {
      ...
      super(),
        ...
        zo.forEach((e) => {
          let t = new Map(),
            ...
            [a, s] = n.split("^");
          a.split(",").forEach((l) => {
            this._schema.set(l.toLowerCase(), t),
              this._eventSchema.set(l.toLowerCase(), r);
          });
    ...
    hasElement(e, t) {
      return t.some((r) => r.name === vn.name) ||
        (e.indexOf("-") > -1 &&
          (En(e) || bn(e) || t.some((r) => r.name === Fn.name)))
        ? !0
  ...
  return (
    We ||
      ...
      (We = Object.assign(Object.create(null), {
        ...
        title: new E({
          contentType: { default: z.ESCAPABLE_RAW_TEXT, svg: z.PARSABLE_DATA },
        }),
        textarea: new E({
          contentType: z.ESCAPABLE_RAW_TEXT,
          ignoreFirstLf: !0,
        }),
      })),
...
function ll(e, t, r, n = {}) {
  ...
  return (
    u.tokenize(), new ol(Cl(u.tokens), u.errors, u.nonNormalizedIcuExpressions)
  );
}
var cl = /\r\n?/g;
function xe(e) {
    ...
    constructor(e, t, r) {
      (this._getTagContentType = t),
        ...
        (this._leadingTriviaCodePoints =
          ...
          r.leadingTriviaChars.map((u) => u.codePointAt(0) || 0)),
...
`,
    ...
    _consumeBlockParameters() {
      for (
        this._attemptCharCodeUntilFn(Tn);
    ...
    _tokenizeExpansionForm() {
      ...
      if (ml(this._cursor.peek()) && this._isInExpansionForm())
    ...
    _consumePrefixAndName() {
      let e = this._cursor.clone(),
        t = "";
      for (; this._cursor.peek() !== 58 && !dl(this._cursor.peek()); )
        this._cursor.advance();
      let r;
    ...
    _consumeRawTextWithTagClose(e, t, r) {
      this._consumeRawText(r, () =>
        ...
        (this._attemptCharCodeUntilFn(_),
        !this._attemptStrCaseInsensitive(e ? `${e}:${t}` : t))
          ? !1
    ...
    _consumeAttributeName() {
      ...
      if (e === 39 || e === 34)
        throw this._createError(xe(e), this._cursor.getSpan());
      this._beginToken(14);
      let t = this._consumePrefixAndName();
...
var Qu = class Fr {
    ...
    advanceState(t) {
      if (t.offset >= this.end)
        throw ((this.state = t), new Jr('Unexpected character "EOF"', this));
      let r = this.charAt(t.offset);
      r === 10 ? (t.line++, (t.column = 0)) : qu(r) || t.column++,
        t.offset++,
        this.updatePeek(t);
    }
    updatePeek(t) {
      ...
      if (t() === 92)
        if (
          ...
          (this.state.peek = parseInt(r, 8)),
            (this.internalState = u.internalState);
        } else
    ...
    decodeHexDigits(t, r) {
      ...
      if (isNaN(u))
        throw (
          ...
          new Jr("Invalid hexadecimal escape sequence", t))
        );
      return u;
    }
  },
  ...
  El = class ei {
    ...
    build() {
      ...
      for (let t of this._containerStack)
        t instanceof Be &&
          this.errors.push(
            R.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`),
          );
    }
    _advance() {
      let t = this._peek;
    ...
    _consumeCdata(t) {
      ...
      this._addToParent(
        new Xo(n, new b(t.sourceSpan.start, (u || r).sourceSpan.end), [r]),
      );
    }
    _consumeComment(t) {
    ...
    _consumeExpansion(t) {
      ...
      this._addToParent(new Qo(r.parts[0], n.parts[0], u, i, r.sourceSpan)),
        this._advance();
    }
    _parseExpansionCase() {
      let t = this._advance();
    ...
    _collectExpansionExpTokens(t) {
      ...
      for (;;) {
        ...
        if (this._peek.type === 30)
          return (
            this.errors.push(
              R.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'."),
            ),
            null
          );
...
`
        ...
        i != null &&
          ...
          ((u = u.substring(1)),
          (r[0] = { type: t.type, sourceSpan: t.sourceSpan, parts: [u] }));
      }
      for (
        ;
      ...
      if (u.length > 0) {
        let i = t.sourceSpan;
        this._addToParent(
          new Yo(u, new b(n.start, i.end, n.fullStart, n.details), r),
        );
      }
    }
    _closeVoidElement() {
    ...
    _consumeStartTag(t) {
      ...
      for (; this._peek.type === 14; )
        u.push(this._consumeAttr(this._advance()));
      ...
      this._pushContainer(
        D,
        p instanceof oe &&
          this.getTagDefinition(p.name).isClosedByChild(D.name),
      ),
        a
          ? this._popContainer(i, oe, o)
          : t.type === 4 &&
            (this._popContainer(i, oe, null),
            this.errors.push(
              R.create(i, o, `Opening tag "${i}" not terminated.`),
            ));
    }
    _pushContainer(t, r) {
      ...
      if (r && this.getTagDefinition(r).isVoid)
        this.errors.push(
          R.create(
            r,
            t.sourceSpan,
            `Void elements do not have end tags "${t.parts[1]}"`,
          ),
        );
    ...
    _popContainer(t, r, n) {
      ...
      for (let i = this._containerStack.length - 1; i >= 0; i--) {
        ...
        if (
          gt(a.name)
            ? a.name === t
            : (t == null || a.name.toLowerCase() === t.toLowerCase()) &&
              a instanceof r
        )
          return (
            (a.endSourceSpan = n),
        ...
        (a instanceof Be ||
          (a instanceof oe && !this.getTagDefinition(a.name).closedByParent)) &&
          (u = !0);
      }
      return !1;
    }
    _consumeAttr(t) {
      ...
      let l =
        ...
        o &&
        new b(
          (u == null ? void 0 : u.sourceSpan.start) ?? s.start,
          o,
          (u == null ? void 0 : u.sourceSpan.fullStart) ?? s.fullStart,
        );
      return new el(
        r,
        i,
    ...
    _getClosestParentElement() {
      for (let t = this._containerStack.length - 1; t > -1; t--)
        if (this._containerStack[t] instanceof oe)
    ...
    _getElementFullName(t, r, n) {
      if (
        t === "" &&
        ((t = this.getTagDefinition(r).implicitNamespacePrefix || ""),
        t === "" && n != null)
      ) {
        let u = Vt(n.name)[1];
        this.getTagDefinition(u).preventNamespaceInheritance ||
          (t = gt(n.name));
      }
      return St(t, r);
    }
...
var Bl = _l,
  ...
  Tl = class Ue {
    constructor(t = {}) {
      for (let r of new Set([...Pn, ...Object.keys(t)]))
    ...
    map(t) {
      ...
      for (let n in dt) {
        ...
        if (u) {
          ...
          r !== u &&
            (r || (r = new Ue({ parent: this.parent })), r.setProperty(n, i));
        }
      }
  ...
  if (e.type === "block") {
    ...
    e.parameters = {
      ...
      sourceSpan: new b(
        ...
        Pt(!1, e.parameters, -1).sourceSpan.end,
      ),
    };
  }
}
  ...
  if (n === "vue") {
    ...
    let f,
      ...
      y = (v) =>
        C().rootNodes.find(
          ({ startSourceSpan: w }) =>
            w && w.start.offset === v.startSourceSpan.start.offset,
        ) ?? v;
    for (let [v, w] of c.entries()) {
      ...
      if (S === null) (D = C().errors), (c[v] = y(w));
        ...
        let K = C().errors.find(
          (W) =>
            W.span.start.offset > x.start.offset &&
            W.span.start.offset < S.end.offset,
        );
        K && In(K), (c[v] = y(w));
      }
    }
  ...
  let p = (f) => {
    ...
    m = (f) => {
      if (
        ...
        (i &&
          (!f.namespace ||
            f.namespace === f.tagDefinition.implicitNamespacePrefix ||
            Xe(f)) &&
          (f.name = d(f.name, (C) => xl.has(C))),
        a)
      )
        for (let C of f.attrs)
          C.namespace ||
            (C.name = d(
              C.name,
              (y) =>
                or.has(f.name) && (or.get("*").has(y) || or.get(f.name).has(y)),
            ));
    },
    g = (f) => {
      f.sourceSpan &&
        f.endSourceSpan &&
        (f.sourceSpan = new b(f.sourceSpan.start, f.endSourceSpan.end));
    },
    F = (f) => {
      if (f.type === "element") {
        let C = Cr(o ? f.name : f.name.toLowerCase());
        !f.namespace || f.namespace === C.implicitNamespacePrefix || Xe(f)
          ? (f.tagDefinition = C)
          : (f.tagDefinition = Cr(""));
      }
    };
...
function Rl(e, t) {
  ...
  let n =
    (r = e.attrs.find((u) => u.name === "lang")) == null ? void 0 : r.value;
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let u of Xl(t))
        !Zl.call(e, u) &&
          ...
          zt(e, u, {
            get: () => t[u],
            enumerable: !(n = Yl(t, u)) || n.enumerable,
          });
    return e;
  },
  it = (e, t, r) => (
  ...
  nc = Gt((e) => {
    ...
    t.prototype = {
          ...
          for (var f = -1 * p; f <= p; f += 2) {
            ...
            if (
              (!S || (x && y.newPos < v.newPos)
                ...
                : ((C = y),
                  C.newPos++,
                  o.pushComponent(C.components, !0, void 0)),
      ...
      extractCommon: function (u, i, a, s) {
        for (
          var o = i.length, l = a.length, c = u.newPos, D = c - s, p = 0;
          c + 1 < o && D + 1 < l && this.equals(i[c + 1], a[D + 1]);
      ...
      equals: function (u, i) {
        return this.options.comparator
          ...
          : u === i ||
              (this.options.ignoreCase && u.toLowerCase() === i.toLowerCase());
      },
    ...
    function r(u, i, a, s, o) {
      for (var l = 0, c = i.length, D = 0, p = 0; l < c; l++) {
        ...
        if (h.removed) {
          if (
            ((h.value = u.join(s.slice(p, p + h.count))),
            (p += h.count),
            l && i[l - 1].added)
          ) {
            var d = i[l - 1];
...
var ai,
  ...
  ac = Gt((e) => {
    ...
    function a(h) {
      return h
        ? (i != null ||
            (i = new r.default.constructor({ enabled: !0, level: 1 })),
          i)
        : r.default;
    }
    var s = !1;
        ...
        W = (g ? (0, t.default)(h, m) : h)
          ...
          .map((T, V) => {
            ...
            if (ot) {
              let rr = "";
              if (Array.isArray(ot)) {
                let Yi = T.slice(0, Math.max(ot[0] - 1, 0)).replace(
                    /[^\t]/g,
                    " ",
                  ),
                  Xi = ot[1] || 1;
      ...
      switch (a) {
        ...
        case P:
          if (n && i.expandedStates)
            for (let s = i.expandedStates.length, o = s - 1; o >= 0; --o)
              u.push(i.expandedStates[o]);
...
function Ic(e) {
  if ((e.type === P && e.break) || (e.type === B && e.hard) || e.type === $)
    return !0;
}
function Oc(e) {
  return en(e, Ic, !1);
...
function $n(e) {
  for (
    e = [...e];
    e.length >= 2 && k(!1, e, -2).type === B && k(!1, e, -1).type === $;
  ...
  for (; r >= 0; ) {
    ...
    switch (ke(c)) {
      ...
      case P: {
        ...
        let D = c.break ? N : l,
          p =
            c.expandedStates && D === N
              ? k(!1, c.expandedStates, -1)
              : c.contents;
        s.push({ mode: D, doc: p });
        break;
      }
...
`,
      ...
      case j: {
        ...
        let x = { ind: p, mode: h, doc: pi(g) },
          K = g[0];
        Dt({ ind: p, mode: Y, doc: [F, f, K] }, [], m, l.length > 0, r, !0)
          ? a.push(x, w, C)
          : v
            ? a.push(x, S, C)
            : a.push(x, S, y);
      ...
      case B:
        switch (h) {
          ...
          case N:
            if (l.length > 0) {
              a.push({ ind: p, mode: h, doc: d }, ...l.reverse()),
                (l.length = 0);
              break;
            }
            d.literal
...
function Z(e) {
  ...
  return e.type === M
    ? {
        ...e,
        breakContents: Z(e.breakContents),
        flatContents: Z(e.flatContents),
      }
    : e.type === P
      ? {
          ...e,
...
function Kc(e) {
  ...
  function n(i, a, s) {
    ...
    if (i.type === B) {
      let c =
        ((o = s == null ? void 0 : s[a + 1]) == null ? void 0 : o.type) === $;
      return i.literal
        ? c
          ? "literalline"
    ...
    if (i.type === $)
      return ((l = s == null ? void 0 : s[a - 1]) == null ? void 0 : l.type) ===
        B && s[a - 1].hard
        ? void 0
        : "breakParent";
    ...
    if (i.type === M)
      return (
        ...
        (i.groupId
          ? (i.flatContents ? "" : ', ""') + `, { groupId: ${u(i.groupId)} }`
          : "") +
        ")"
      );
    if (i.type === ue) {
      let c = [];
      i.negate && c.push("negate: true"),
        i.groupId && c.push(`groupId: ${u(i.groupId)}`);
      let D = c.length > 0 ? `, { ${c.join(", ")} }` : "";
      return `indentIfBreak(${n(i.contents)}${D})`;
    }
    if (i.type === P) {
      let c = [];
      i.break && i.break !== "propagated" && c.push("shouldBreak: true"),
        i.id && c.push(`id: ${u(i.id)}`);
      let D = c.length > 0 ? `, { ${c.join(", ")} }` : "";
      return i.expandedStates
        ? `conditionalGroup([${i.expandedStates.map((p) => n(p)).join(",")}]${D})`
        : `group(${n(i.contents)}${D})`;
    }
  ...
  function u(i) {
    ...
    for (let s = 0; ; s++) {
      let o = a + (s > 0 ? ` #${s}` : "");
      if (!r.has(o))
        return r.add(o), (t[i] = `Symbol.for(${JSON.stringify(o)})`);
    }
  }
}
function Jc(e, t, r = 0) {
  ...
  for (let u of Qc(Object.assign({}, ...e.map(({ options: i }) => i), Yc)))
    (!t && u.deprecated) ||
      (Array.isArray(u.choices) &&
        ...
        u.name === "parser" &&
          (u.choices = [...u.choices, ...Xc(u.choices, r, e)])),
      (u.pluginDefaults = Object.fromEntries(
        e
          .filter((i) => {
            var a;
            return (
              ((a = i.defaultOptions) == null ? void 0 : a[u.name]) !== void 0
            );
          })
    ...
    if (u.parsers) {
      for (let i of u.parsers)
        if (!n.has(i)) {
          ...
          let a = r.find(
              (o) =>
                o.parsers && Object.prototype.hasOwnProperty.call(o.parsers, i),
            ),
            s = u.name;
          a != null && a.name && (s += ` (plugin: ${a.name})`),
...
function Qc(e) {
  ...
  for (let [r, n] of Object.entries(e)) {
    let u = { name: r, ...n };
    Array.isArray(u.default) && (u.default = k(!1, u.default, -1).value),
      t.push(u);
  }
  return t;
}
...
var rp = tp,
  Te = {
    ...
    value(e) {
      ...
      return t.length === 0
        ? "{}"
        : `{ ${t.map((r) => `${Te.key(r)}: ${Te.value(e[r])}`).join(", ")} }`;
    },
  ...
  np = (e, t, { descriptor: r }) => {
    let n = [
      `${Un.default.yellow(typeof e == "string" ? r.key(e) : r.pair(e))} is deprecated`,
    ];
    return (
      t &&
        n.push(
          `we now treat it as ${Un.default.blue(typeof t == "string" ? r.key(t) : r.pair(t))}`,
        ),
      n.join("; ") + "."
    );
  },
  ...
  zn = " ".repeat(2),
  up = (e, t, r) => {
    let { text: n, list: u } = r.normalizeExpectedResult(
    ...
    return (
      ...
      u &&
        i.push(
          [Gn(e, t, u.title, r.descriptor)].concat(
            u.values.map((a) => wi(a, r.loggerPrintWidth)),
          ).join(`
`),
        ),
    ...
    t &&
      n.push(
        [`- ${Le.default.blue(t.title)}:`].concat(
          t.values.map((u) => wi(u, r - zn.length).replace(/^|\n/g, `$&${zn}`)),
        ).join(`
`),
      ),
    Si(n, r)
...
function ip(e, t) {
  ...
  for (; D < u; )
    for (a = t.charCodeAt(i + D), o = D++, s = D, c = 0; c < n; c++)
      (l = a === Jn[c] ? o : o + 1),
        (o = lr[c]),
        (s = lr[c] = o > s ? (l > s ? s + 1 : l) : l > o ? o + 1 : l);
  return s;
}
var Ai = (e, t, { descriptor: r, logger: n, schemas: u }) => {
    let i = [
        `Ignored unknown option ${Kn.default.yellow(r.pair({ key: e, value: t }))}.`,
      ],
      a = Object.keys(u)
        .sort()
        .find((s) => ip(e, s) < 3);
    a && i.push(`Did you mean ${Kn.default.blue(r.key(a))}?`),
      n.warn(i.join(" "));
  },
  ap = [
    "default",
...
var lp = class extends De {
  ...
  pp = class extends De {
    ...
    expected(e) {
      let { text: t, list: r } = e.normalizeExpectedResult(
    ...
    deprecated(e, t) {
      let r = [];
      for (let n of e) {
        let u = t.normalizeDeprecatedResult(
...
function ki(e) {
  ...
  return (
    ...
    r
      ? { text: t, list: { title: r.title, values: r.values.map(ki) } }
      : { text: t }
  );
}
function Qn(e, t) {
    ...
    _applyNormalization(e, t) {
      ...
      for (let i of n) {
              ...
              if (h === !0)
                this._hasDeprecationWarned(i) ||
                  this._utils.logger.warn(
                    this._deprecatedHandler(i, p, this._utils),
                  );
              else
                for (let { value: d } of h) {
                  ...
                  if (!this._hasDeprecationWarned(m)) {
                    ...
                    this._utils.logger.warn(
                      this._deprecatedHandler(m, g, this._utils),
                    );
                  }
                }
          };
        ...
        if ((c.redirect.forEach(o), "remain" in c)) {
          let D = c.remain;
          (t[i] = i in t ? a.overlap(t[i], D, this._utils) : D),
            l({ value: D });
        }
        for (let { from: D, to: p } of c.redirect)
          l({ value: D, redirectTo: p });
      }
      for (let i of u) {
        let a = e[i];
    ...
    _applyRequiredCheck(e) {
      for (let t of Object.keys(this._utils.schemas))
        if (this._identifyMissing(t, e) && this._identifyRequired(t))
          throw this._invalidHandler(t, bi, this._utils);
    }
...
function xp(e, { isCLI: t, FlagSchema: r }) {
  ...
  for (let u of e)
    n.push(Tp(u, { isCLI: t, optionInfos: e, FlagSchema: r })),
      u.alias && t && n.push(lp.create({ name: u.alias, sourceName: u.name }));
  return n;
}
function Tp(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
      ...
      (a = n),
        (i.flags = r.flatMap((o) =>
          [
            ...
            o.oppositeDescription && `no-${o.name}`,
          ].filter(Boolean),
        ));
      break;
    case "path":
  ...
  if (
    ...
    i.preprocess = (l, c, D) =>
      c.preprocess(o(Array.isArray(l) ? k(!1, l, -1) : l), D);
  }
  return e.array
    ? pp.create({
        ...(t ? { preprocess: (o) => (Array.isArray(o) ? o : [o]) } : {}),
        ...s,
        valueSchema: a.create(i),
      })
    : a.create({ ...i, ...s });
}
var Lp = Bp;
function _i(e, t) {
  ...
  for (let n = e.length - 1; n >= 0; n--) {
    let u = e[n];
    if (u.parsers && Object.prototype.hasOwnProperty.call(u.parsers, t))
      return u;
  }
...
function Np(e, t) {
  ...
  for (let n = e.length - 1; n >= 0; n--) {
    let u = e[n];
    if (u.printers && Object.prototype.hasOwnProperty.call(u.printers, t))
      return u;
  }
...
async function Pp(e, t = {}) {
  ...
  let u = Ei({ plugins: e.plugins, showDeprecated: !0 }).options,
    i = {
      ...nu,
      ...Object.fromEntries(
        u.filter((p) => p.default !== void 0).map((p) => [p.name, p.default]),
      ),
    },
  ...
  let o =
      (r = a.printers) != null && r[s.astFormat]
        ? a
        : Np(n.plugins, s.astFormat),
    l = await qp(o, s.astFormat);
  n.printer = l;
  let c = o.defaultOptions
      ? Object.fromEntries(
          Object.entries(o.defaultOptions).filter(([, p]) => p !== void 0),
        )
      : {},
    D = { ...i, ...c };
  for (let [p, h] of Object.entries(D))
    (n[p] === null || n[p] === void 0) && (n[p] = h);
  return (
    n.parser === "json" && (n.trailingComma = "none"),
    Lp(n, u, { passThrough: Object.keys(nu), ...t })
  );
}
var He = Pp,
  Ti = new Set([
  ...
  Wp = class {
    ...
    each(e, ...t) {
      ...
      try {
        for (let i = 0; i < u.length; ++i)
          r.push(i, u[i]), e(this, i, u), (r.length -= 2);
      } finally {
        r.length = n;
      }
    }
    ...
    match(...e) {
      ...
      for (let u of e) {
        ...
        if (
          (typeof r == "number" &&
            ((i = r), (r = this.stack[t--]), (n = this.stack[t--])),
          u && !u(n, r, i))
        )
          return !1;
...
function nn(e, t) {
  ...
  if (!n) return [];
  let s = (
    (r == null ? void 0 : r(e, t)) ?? [...Pi(e, { getVisitorKeys: er(u) })]
  ).flatMap((o) => (n(o) ? [o] : nn(o, t)));
...
function e2(e, t) {
  ...
  for (let [h, d] of p.entries()) {
    ...
    if (
      ...
      (m.placement = "ownLine"),
        l(...S) || (f ? Ne(f, m) : g ? qe(g, m) : Et(F || v, m));
    else if (r2(C, y, p, h))
      (m.placement = "endOfLine"),
        c(...S) || (g ? qe(g, m) : f ? Ne(f, m) : Et(F || v, m));
...
function uu(e, t) {
  ...
  for (o = u; o > 0; --o) {
    ...
    if (
      ((n = (r = t.printer).isGap) == null ? void 0 : n.call(r, p, t)) ??
      /^[\s(]*$/.test(p)
    )
      s = t.locStart(l);
    else break;
...
function iu(e, t, r, n, u) {
  ...
  let { node: a } = e,
    ...
    o;
  return (
    (i = s.hasPrettierIgnore) != null && i.call(s, e)
      ? (o = h2(e, t))
      : u.has(a)
        ? (o = u.get(a))
        : (o = s.print(e, t, r, n)),
...
async function $i(e, t, r = 0) {
  ...
  if (r > 0) {
    ...
    a.cursorNodeStart !== void 0 &&
      (a.cursorNodeStart -= a.formatted.indexOf(o)),
      (a.formatted = o + Qr(t.endOfLine));
  }
...
`,
    ...
    c = await $i(
      a,
      {
        ...
        cursorOffset:
          t.cursorOffset > u && t.cursorOffset <= i ? t.cursorOffset - u : -1,
        endOfLine: "lf",
      },
      l,
    ),
  ...
  p > i
    ? (p += D.length - a.length)
    : c.cursorOffset >= 0 && (p = c.cursorOffset + u);
  ...
  return (
    u.rangeStart > 0 || u.rangeEnd < n.length
      ...
      : (!u.requirePragma &&
        ...
        (i = await $i(n, u))),
    r &&
      ((i.formatted = ji + i.formatted),
      i.cursorOffset >= 0 && i.cursorOffset++),
    i
  );
}
async function E2(e, t, r) {
  ...
  return (
    r &&
      (r.preprocessForPrint && (i.ast = await Ri(i.ast, u)),
      r.massage && (i.ast = Rp(i.ast, u))),
    i
  );
}
...
function B2(e, t) {
  let r = null,
    n = t;
  for (; n !== r; )
    (r = n), (n = he(e, n)), (n = an(e, n)), (n = sn(e, n)), (n = Ee(e, n));
  return n;
}
var on = B2;
function x2(e, t) {
...
function L2(e, t) {
  ...
  return r === null
    ? 0
    : r.reduce((n, u) => Math.max(n, u.length / t.length), 0);
}
var N2 = L2;
function q2(e, t) {
  let r = e.lastIndexOf(`
...
function me(e, t = 1) {
  return async (...r) => {
    let n = r[t] ?? {},
      u = n.plugins ?? [];
    return (
      (r[t] = { ...n, plugins: Array.isArray(u) ? u : Object.values(u) }),
      e(...r)
    );
  };
}
