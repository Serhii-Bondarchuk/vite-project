import { c as Bu, g as Uu } from "./_commonjsHelpers-BosuxZz1.js";
function Ar(u, e) {
...
du.prototype.add = du.prototype.push = Da;
du.prototype.has = Aa;
var oa = du;
function Fa(u, e) {
...
function da(u, e, r, t, a, i) {
  ...
  for (i.set(u, e), i.set(e, u); ++x < C; ) {
    ...
    if (m) {
      if (
        !fa(e, function (I, L) {
          if (!pa(m, L) && (v === I || a(v, I, r, t, i))) return m.push(L);
        })
      ) {
        F = !1;
        break;
...
function qa(u, e, r, t, a, i, n) {
  switch (r) {
    ...
    case Ua:
      var E = t & Oa;
      if ((C || (C = wa), u.size != e.size && !E)) return !1;
      var f = n.get(u);
      if (f) return f == e;
      (t |= Na), n.set(u, e);
      var T = Sa(C(u), C(e), t, a, i, n);
      return n.delete(u), T;
    case Ga:
...
var Bn = pn,
  ...
  hn = cu,
  Pe = Object.prototype,
  dn = Pe.hasOwnProperty,
  vn = Pe.propertyIsEnumerable,
  yn = De(
    (function () {
      return arguments;
    })(),
    ...
    ? De
    : function (u) {
        return hn(u) && dn.call(u, "callee") && !vn.call(u, "callee");
      },
  Ie = yn,
  vu = { exports: {} };
function gn() {
...
function yi(u) {
  var e = u && u.constructor,
    r = (typeof e == "function" && e.prototype) || vi;
  return u === r;
}
var gi = yi;
function mi(u, e) {
...
function Ts(u, e, r, t, a, i) {
  ...
  if (F && !T)
    return (
      i || (i = new Pu()),
      n || ms(u) ? vs(u, e, r, t, a, i) : ys(u, e, E, r, t, a, i)
    );
  if (!(r & _s)) {
...
function Ps(u, e, r, t) {
  ...
  for (; ++a < i; ) {
    ...
    if (n && C[2]) {
      ...
      if (!(F === void 0 ? ws(T, f, Os | Ns, t, x) : F)) return !1;
    }
  }
  return !0;
}
...
var vD = dD,
  ...
  _D = vD;
function xD(u, e) {
  return yD(u) ? u : gD(u, e) ? [u] : mD(_D(u));
}
var ze = xD,
  TD = zu,
  bD = 1 / 0;
  ...
  function f(F) {
    ...
    for (I = u.isIdentifierStartES6, m = 0, v = F.length; m < v; ++m) {
      if (((c = F.charCodeAt(m)), 55296 <= c && c <= 56319)) {
        if (
          (++m, m >= v || ((p = F.charCodeAt(m)), !(56320 <= p && p <= 57343)))
        )
          return !1;
        c = E(c, p);
      }
  ...
  function I() {
    ...
    for (D = r.charAt(a), ++a; a < t; )
      if (((d = c()), d === D)) {
        ...
        if (((d = c()), E.code.isLineTerminator(d.charCodeAt(0))))
          d === "\r" && r.charCodeAt(a) === 10 && ++a;
        else
          switch (d) {
            case "n":
              s += `
`;
  ...
  function L() {
    ...
    if (((s = ""), (D = r.charCodeAt(a)), D !== 46)) {
      if (((s = c()), (D = r.charCodeAt(a)), s === "0")) {
        if (D === 120 || D === 88) {
          for (
            s += c();
            a < t && ((D = r.charCodeAt(a)), !!E.code.isHexDigit(D));
        ...
        if (E.code.isOctalDigit(D)) {
          for (
            s += c();
            a < t && ((D = r.charCodeAt(a)), !!E.code.isOctalDigit(D));
      ...
      for (; a < t && ((D = r.charCodeAt(a)), !!E.code.isDecimalDigit(D)); )
        s += c();
    }
    if (D === 46)
      for (
        s += c();
        a < t && ((D = r.charCodeAt(a)), !!E.code.isDecimalDigit(D));
    ...
    return (
      a < t &&
        ((D = r.charCodeAt(a)),
        E.code.isIdentifierStartES5(D) && f.throwError("unexpected token")),
      (C = parseFloat(s)),
      e.NUMBER
    );
  }
  ...
  function M() {
    ...
    switch (((s = r.charCodeAt(a)), s)) {
      ...
      case 45:
        return (n = L()), n;
      default:
        return E.code.isDecimalDigit(s)
          ? ((n = L()), n)
          : (f.assert(F(s)), (n = z()), n);
    }
  }
  ...
  function k() {
    ...
    return (
      ...
      v({ type: u.UnionType, elements: s }, [D, i])
    );
  }
  function B() {
    var s,
    ...
    for (
      ...
      if (n === e.REST) {
        (d = a - 3),
          _(e.REST),
          s.push(v({ type: u.RestType, expression: U() }, [d, i]));
        break;
      } else s.push(U());
    ...
    return (
      ...
      n === e.DOT_LT || n === e.LT
        ? (M(),
          (D = Eu()),
          l(e.GT),
          v({ type: u.TypeApplication, expression: s, applications: D }, [
            d,
            i,
          ]))
        : s
    ...
    for (var s = [], D = !1, d, o = !1, A, h = a - 3, y; n !== e.RPAREN; )
      n === e.REST && (_(e.REST), (o = !0)),
        ...
        d.type === u.NameExpression &&
          ...
          ((y = i - d.name.length),
          _(e.COLON),
          (d = v({ type: u.ParameterType, name: d.name, expression: U() }, [
            y,
            i,
          ]))),
        n === e.EQUAL
          ? (_(e.EQUAL),
            (d = v({ type: u.OptionalType, expression: d }, [A, i])),
            (D = !0))
    ...
    switch (n) {
      ...
      case e.NAME:
        if (((D = a - C.length), C === "null"))
          return _(e.NAME), v({ type: u.NullLiteral }, [D, i]);
        if (C === "undefined")
          return _(e.NAME), v({ type: u.UndefinedLiteral }, [D, i]);
        if (C === "true" || C === "false")
          return (
            _(e.NAME),
            v({ type: u.BooleanLiteralType, value: C === "true" }, [D, i])
          );
      ...
      case e.STRING:
        return (
          M(), v({ type: u.StringLiteralType, value: C }, [i - C.length - 2, i])
        );
      case e.NUMBER:
        return (
          M(),
          v({ type: u.NumericLiteralType, value: C }, [i - String(C).length, i])
        );
      default:
        f.throwError("unexpected token");
    }
  ...
  function U() {
    ...
    return n === e.QUESTION
      ...
      : n === e.BANG
        ? ((D = a - 1),
          _(e.BANG),
          v({ type: u.NonNullableType, expression: iu(), prefix: !0 }, [D, i]))
        : ((D = i),
          (s = iu()),
          n === e.BANG
            ? (_(e.BANG),
              v({ type: u.NonNullableType, expression: s, prefix: !1 }, [D, i]))
            : n === e.QUESTION
              ? (_(e.QUESTION),
                v({ type: u.NullableType, expression: s, prefix: !1 }, [D, i]))
              : n === e.LBRACK
                ? (_(e.LBRACK),
                  l(
                    e.RBRACK,
  ...
  function J() {
    ...
    return n === e.REST
      ...
      : ((s = K()),
        n === e.EQUAL
          ? (_(e.EQUAL), v({ type: u.OptionalType, expression: s }, [0, a]))
          : s);
  }
  function pu(s, D) {
    var d;
    return (
      ...
      (d = K()),
      D && D.midstream
        ? { expression: d, index: i }
        : (n !== e.EOF && f.throwError("not reach to EOF"), d)
    );
  }
  function wu(s, D) {
    var d;
...
(function (u) {
  (function () {
    ...
    function E(l) {
      return (
        (l >= 97 && l <= 122) || (l >= 65 && l <= 90) || (l >= 48 && l <= 57)
      );
    }
    function f(l) {
...
\u2028\u2029])`;
    ...
    function _(l, k) {
      for (
        var B = l.replace(/^\/\*\*?/, ""), j = 0, G = new RegExp(z, "g"), g;
        (g = G.exec(B));

      )
        if (((j += g[1].length), g.index + g[0].length > k + j))
          return k + j + l.length - B.length;
...
var ur = /^['"]|['"]$/g,
  ...
  er = (u) => {
    let e = fA(u);
    return pA(u) || Number.isNaN(Number(e)) ? e : Number(e);
  },
  BA = (u) => {
    switch (u.type) {
      case "function":
        ...
        return (
          (a = u.elements) != null && a.every((f) => f.name === "literal")
            ? (E = {
                ...
                name: "enum",
                value:
                  (i = u.elements) == null ? void 0 : i.map((f) => er(f.value)),
              })
            : (E = {
                ...t,
                name: e,
                value: (n = u.elements) == null ? void 0 : n.map(Fu),
              }),
          E
        );
      case "intersection":
        return {
          ...t,
          name: e,
          value: (C = u.elements) == null ? void 0 : C.map(Fu),
        };
      default:
  ...
  Cu = (u) => {
    ...
    switch ((typeof r < "u" && (t.raw = r), u.name)) {
      ...
      case "signature":
        return { ...t, ...vA(u) };
      case "union":
        return (a = u.elements) != null && a.every(hA)
          ? {
              ...t,
              name: "enum",
              value: (i = u.elements) == null ? void 0 : i.map(dA),
            }
          : {
              ...t,
              name: e,
              value: (n = u.elements) == null ? void 0 : n.map(Cu),
            };
      case "intersection":
        return {
          ...t,
          name: e,
          value: (C = u.elements) == null ? void 0 : C.map(Cu),
        };
      default:
        return { ...t, name: "other", value: e };
    }
...
function HA(u, e) {
  if (u != null) {
    let { value: r } = u;
    if (!Yu(r)) return LA(r) ? P(e == null ? void 0 : e.name, r) : P(r);
  }
  return null;
}
var qA = (u, e) => {
